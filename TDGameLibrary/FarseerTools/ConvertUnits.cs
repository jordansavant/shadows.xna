...
namespace FarseerTools
{
    ...
    {
        // This is where you define how many pixels on screen represent one meter
        // It is the primary scaling factor that is used for converting the physical MKS units to Pixel units
        // Change this in your game world.
